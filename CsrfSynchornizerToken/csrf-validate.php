                    ...
                    <div class="row">
						...
						if(isset($_COOKIE['session_cookie']))
						{
							...
							if ($_POST['csrf_Token'] == $_SESSION['CSRF_Token'])
							{
								...
								echo "<div class='alert alert-secondary' role='alert'>".$lname."</div>";
								echo "<div class='alert alert-success' role='alert'>".$age."</div>";
								echo "<div class='alert alert-info' role='alert'>".$gender."</div>";
